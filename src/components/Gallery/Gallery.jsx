...
//                 <div key={index} className="gallery-item" style={{ maxWidth: '300px', textAlign: 'center' }}>
//                     <img 
//                         src={image.src} 
//                         alt={image.desc || 'Gallery Image'} 
//                         style={{ width: '100%', height: 'auto', borderRadius: '8px', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)' }} 
//                     />
//                     <p style={{ margin: '8px 0 4px', fontWeight: 'bold' }}>{image.desc}</p>
//                     <p style={{ fontSize: '0.9rem', color: '#555' }}>{image.sub}</p>
//                 </div>
//             ))}
//         </div>
//     );
