    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="kavitasuthar.in@gmail.com" className="d-block" >kavitasuthar@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="blank" href="tel:9876543210" className="d-block" >8000891472</a>
          </div>
